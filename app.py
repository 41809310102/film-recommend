...
from controller.moviecontroller.api_grade import api_url_grade
from controller.moviecontroller.api_tuijian import api_url_tuijian
from controller.moviecontroller.api_type import api_url_type
...
if __name__ == '__main__':
    ...
    app.register_blueprint(api_url_type, url_prefix='/type')
    app.register_blueprint(api_url_grade, url_prefix='/grade')
    app.register_blueprint(api_url_tuijian, url_prefix='/tj')
