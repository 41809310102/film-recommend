...
# 网页爬取配置参数 cookie_str = http.cookiejar.MozillaCookieJar() cookie_str.load('cookie.txt', ignore_discard=True,
# ignore_expires=True) cookie_str = 'Cookie: ll="108303"; bid=VCwqhdGykZc;
# __yadk_uid=WlU2z5PfT7ayM2AUFMlUVm6XHaxwoUsx;
# _vwo_uuid_v2=D0CA41EDEED1A0C639F0837D53C6F56A7|731b88fd10c962f37b53e476cad040b8; __utmc=30149280; __utmc=223695111;
# ps=y; push_noty_num=0; push_doumail_num=0; __utmv=30149280.18705; ue="1274184982@qq.com";
# __utma=30149280.1927612880.1539001446.1541743879.1541750881.23;
# __utmz=30149280.1541750881.23.8.utmcsr=accounts.douban.com|utmccn=(
# referral)|utmcmd=referral|utmcct=/safety/unlock_sms/resetpassword; dbcl2="187059995:etWky9gmE6A"; ck=S3Xi;
# __utmb=30149280.3.10.1541750881; _pk_ref.100001.4cf6=%5B%22%22%2C%22%22%2C1541750915%2C%22https%3A%2F%2Fwww.douban
# .com%2F%22%5D; _pk_ses.100001.4cf6=*; __utma=223695111.656272146.1539001446.1541743879.1541750915.22;
# __utmb=223695111.0.10.1541750915; __utmz=223695111.1541750915.22.9.utmcsr=douban.com|utmccn=(
# referral)|utmcmd=referral|utmcct=/; _pk_id.100001.4cf6=cb1300d538aa9452.1537752921.24.1541751703.1541743879.'
...
title_text = ['电影ID', '电影名', '国家1', '国家2', '导演1', '导演1 ID', '导演2', '导演2 ID', '编剧1', '编剧1 ID',
              '编剧2', '编剧2 ID',
              '类型1', '类型2', '类型3', '语言1', '语言2', '上映时间', '电影时长', '又名', '短评数量', '评分人数',
              '电影评分',
              '五星比例', '四星比例', '三星比例', '两星比例', '一星比例', '主演1', '主演1 ID', '主演2', '主演2 ID',
              '主演3', '主演3 ID', '主演4', '主演4 ID', '主演5', '主演5 ID', '详情链接', '图片链接']
...
for r in range(len(movie_actor)):
    ...
    for s5 in range(len(desc_urt)):
        sheet1.write(s5 + 1, 38, desc_urt[s5])
    for s5 in range(len(pic_urt)):
        sheet1.write(s5 + 1, 39, pic_urt[s5])
